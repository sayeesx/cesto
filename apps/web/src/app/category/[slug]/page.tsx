          ...
          <aside style={{
            ...
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  <div style={{ 
                    width: 52, height: 52, borderRadius: 12, // Increased from 36
                    background: '#FFFFFF', overflow: 'hidden',
                    border: isActive ? '1px solid rgba(178, 33, 83, 0.2)' : '1px solid #F0F0F0',
                    display: 'flex', alignItems: 'center', justifyContent: 'center'
                  }}>
                    <img src={`/${cat.slug}.webp`} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                  </div>
                  <span style={{ fontSize: 10, fontWeight: isActive ? 900 : 700 }}>{cat.name}</span>
                </Link>
              );
            })}
          </aside>
